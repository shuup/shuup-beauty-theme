...
class NiccaProductHighlightPlugin(TemplatedPlugin):
    identifier = "nicca_theme.product_highlight"
    name = _("Nicca Product Highlights")
    template_name = "nicca/highlight_plugin.jinja"
    fields = [
