...
gulp.task("less", function() {
    return gulp.src([
        ...
        .pipe(gulp.dest("static/shoop_beauty_theme/css/"));
});
...
gulp.task("js", function() {
    return gulp.src([
        ...
        .pipe(plumber({}))
        .pipe(concat("shoop_beauty_theme.js"))
        .pipe((PRODUCTION ? uglify() : gutil.noop()))
        .pipe(gulp.dest("static/shoop_beauty_theme/js/"));
});
...
gulp.task("copy_fonts", function() {
    ...
    ]).pipe(gulp.dest("static/shoop_beauty_theme/fonts/"));
});
